...
export class FaucetApiClient {
  ...
  // Request withdrawal
  async requestWithdrawal(address) {
  ...
  async requestWithdrawalETH(address) {
    return await this._handleRequest(`${this.baseUrl}/eth-withdraw-request`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  async requestWithdrawalAxoHouse(address) {
    return await this._handleRequest(`${this.baseUrl}/axohouse-withdraw-request`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
